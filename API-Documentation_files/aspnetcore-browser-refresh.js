setTimeout(async function () {
  ...
  const webSocketUrls = 'wss://localhost:44396/WordScapeAPI/,ws://localhost:59091/WordScapeAPI/'.split(',');
  const sharedSecret = await getSecret('');
  let connection;
